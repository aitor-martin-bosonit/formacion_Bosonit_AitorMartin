...
public class ProfesorMapper {
        ...
        public ProfesorFullOutputDto toFullDTO(Profesor profesor) {
            ...
            if (profesor.getPerson() != null) {
                ...
                profesorFullDto.setCreatedDate(Date.from(profesor.getPerson().getCreatedDate()));
                profesorFullDto.setImageUrl(profesor.getPerson().getImageUrl());
                profesorFullDto.setTerminationDate(Date.from(profesor.getPerson().getTerminationDate()));
