...
public class PersonController {
    ...
    public ResponseEntity<List<Person>> searchPersons(
        ...
        List<Person> persons = personService.searchPersons(user, name, surname, creationDate, sortBy,pageSize, pageNumber);
    ...
    public ResponseEntity<List<PersonOutputDto>> getPersonsByName(@RequestParam(defaultValue = "simple") String output,
        ...
        List<PersonOutputDto> persons = personService.getPersonsName(pageNumber, pageSize, nombre, output);
    ...
    public ResponseEntity<List<PersonOutputDto>> getAllPersons(
            ...
            @RequestParam(defaultValue = "0", required = false) int pageNumber,
            @RequestParam(defaultValue = "4", required = false) int pageSize) {
        List<PersonOutputDto> persons = personService.getAllPersons(pageNumber, pageSize, output);
